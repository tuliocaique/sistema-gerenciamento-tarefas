                    ...
                    <div class="col-xl-12">
                        <div class="rounded shadow-lg" style="padding: 50px 50px;">
                            <form id="login">
                                ...
                                <button type="submit" class="btn btn-primary btn-block bg-primary-blue" id="btn-login"><i class="fas fa-sign-in-alt"></i> Login</button>
                            </form>
                            <div class="new-account mt-3">
                                <p>Não tem uma conta? <a class="text-primary" href="./cadastrar">Cadastre-se</a></p>
                            </div>
                        </div>
                    </div>
                </div>
